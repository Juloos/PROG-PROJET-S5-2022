 ...
 * Résultat: renvoie un pointeur sur une structure SymbolsTable correspondant à la fusion et renumérotation des tables des symboles des 2 fichiers ELF en entrée
 * Effet de bord : alloue de la mémoire dynamiquement qu'il faut libérer manuellement
 */
